...
authorOf(naomi_novik, a_deadly_education).
...
publishedBy(del_ray, a_deadly_education).
...
publicationYear(kiss_the_girls, 1995).
publicationYear(random_case, 1995).
publicationYear(answer_case, 1995).
